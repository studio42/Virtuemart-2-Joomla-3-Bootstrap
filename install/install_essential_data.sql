...
( 1, 0, 'COM_VIRTUEMART_CATEGORY_S', '', '', 'icon-folder', 1, 1, '', 'category', ''),
( 1, 0, 'COM_VIRTUEMART_PRODUCT_S', '', '', 'icon-camera', 2, 1, '', 'product', ''),
( 1, 0, 'COM_VIRTUEMART_PRODUCT_CUSTOM_FIELD_S', '', '', 'icon-equalizer', 3, 1, '', 'custom', ''),
( 1, 0, 'COM_VIRTUEMART_PRODUCT_INVENTORY', '', '', 'icon-health', 7, 1, '', 'inventory', ''),
( 1, 0, 'COM_VIRTUEMART_CALC_S', '', '', 'icon-database', 8, 1, '', 'calc', ''),
( 1, 0, 'COM_VIRTUEMART_REVIEW_RATE_S', '', '', 'icon-comments-2', 9, 1, '', 'ratings', ''),
( 2, 0, 'COM_VIRTUEMART_ORDER_S', '', '', 'icon-stack', 1, 1, '', 'orders', ''),
( 2, 0, 'COM_VIRTUEMART_COUPON_S', '', '', 'icon-scissors', 10, 1, '', 'coupon', ''),
( 2, 0, 'COM_VIRTUEMART_REPORT', '', '', 'icon-bars', 3, 1, '', 'report', ''),
( 2, 0, 'COM_VIRTUEMART_USER_S', '', '', 'icon-users', 4, 1, '', 'user', ''),
( 2, 0, 'COM_VIRTUEMART_SHOPPERGROUP_S', '', '', 'icon-tree-2', 5, 1, '', 'shoppergroup', ''),
( 3, 0, 'COM_VIRTUEMART_MANUFACTURER_S', '', '', 'icon-briefcase', 1, 1, '', 'manufacturer', ''),
( 3, 0, 'COM_VIRTUEMART_MANUFACTURER_CATEGORY_S', '', '', 'icon-folder', 2, 1, '', 'manufacturercategories', ''),
( 4, 0, 'COM_VIRTUEMART_STORE', '', '', 'icon-home-2', 1, 1, '', 'user', 'editshop'),
( 4, 0, 'COM_VIRTUEMART_MEDIA_S', '', '', 'icon-pictures', 2, 1, '', 'media', ''),
( 4, 0, 'COM_VIRTUEMART_SHIPMENTMETHOD_S', '', '', 'icon-box-add', 3, 1, '', 'shipmentmethod', ''),
( 4, 0, 'COM_VIRTUEMART_PAYMENTMETHOD_S', '', '', 'icon-credit', 4, 1, '', 'paymentmethod', ''),
( 5, 0, 'COM_VIRTUEMART_CONFIGURATION', '', '', 'icon-cogs', 1, 1, '', 'config', ''),
( 5, 0, 'COM_VIRTUEMART_USERFIELD_S', '', '', 'icon-vcard', 2, 1, '', 'userfields', ''),
( 5, 0, 'COM_VIRTUEMART_ORDERSTATUS_S', '', '', 'icon-upload', 3, 1, '', 'orderstatus', ''),
( 5, 0, 'COM_VIRTUEMART_CURRENCY_S', '', '', 'icon-circle', 5, 1, '', 'currency', ''),
( 5, 0, 'COM_VIRTUEMART_COUNTRY_S', '', '', 'icon-flag', 6, 1, '', 'country', ''),
( 11, 0, 'COM_VIRTUEMART_MIGRATION_UPDATE', '', '', 'icon-unblock', 1, 1, '', 'updatesmigration', ''),
( 11, 0, 'COM_VIRTUEMART_ABOUT', '', '', 'icon-info', 2, 1, '', 'about', ''),
( 11, 0, 'COM_VIRTUEMART_HELP_TOPICS', 'http://virtuemart.net/', '', 'icon-help', 4, 1, '', '', ''),
( 11, 0, 'COM_VIRTUEMART_COMMUNITY_FORUM', 'http://forum.virtuemart.net/', '', 'icon-users', 6, 1, '', '', ''),
( 11, 0, 'COM_VIRTUEMART_STATISTIC_SUMMARY', '', '', 'icon-dashboard', 1, 1, '', 'virtuemart', ''),
( 77, 0, 'COM_VIRTUEMART_USER_GROUP_S', '', '', 'vmicon vmicon-16-user', 2, 1, '', 'usergroups', ''),
( 1, 0, 'COM_VIRTUEMART_MEDIA_S', '', '', 'icon-pictures', 4, 1, '', 'media&search_type=product', '');
