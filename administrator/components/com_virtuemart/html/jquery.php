...
abstract class JHtmlJquery
{
	...
	public static function framework($noConflict = true, $debug = null)
	{
		...
		JHtml::_('script', J3UI.'js/jquery.min.js', false, false, false, false, null);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			JHtml::_('script', J3UI.'js/jquery-noconflict.js', false, false, false, false, null);
		}
	...
	public static function ui(array $components = array('core'), $debug = null)
	{
		...
		self::framework();
// full
		JHtml::_('script', 'components/com_virtuemart/assets/js/jquery-ui.min.js', false, false, false, false, null);
