...
abstract class JHtmlFormbehavior
{
	...
	public static function chosen($selector = '.advancedSelect', $debug = null)
	{
		...
		JHtml::_('script', J3UI.'js/chosen.jquery.min.js', false, false, false, false, null);
		JHtml::_('stylesheet', J3UI.'css/chosen.css', false, false);
	...
	public static function ajaxchosen(JRegistry $options, $debug = null)
	{
		...
		if (!empty($url))
		{
			...
			JHtml::_('script', J3UI.'js/ajax-chosen.min.js', false, false, false, false, null);
			JFactory::getDocument()->addScriptDeclaration("
				(function($){
