...
abstract class JToolbarHelper
{
	 ...
	 * @since   1.5
	 */
	public static function back($alt = 'JACTION_BACK', $href = 'javascript:history.back();')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function media_manager($directory = '', $alt = 'JACTION_UPLOAD')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function makeDefault($task = 'default', $alt = 'JACTION_DEFAULT')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function assign($task = 'assign', $alt = 'JACTION_ASSIGN')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function addNew($task = 'add', $alt = 'JACTION_CREATE', $check = false)
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function unpublish($task = 'unpublish', $alt = 'COM_VIRTUEMART_UNPUBLISH', $check = false)
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function unpublishList($task = 'unpublish', $alt = 'COM_VIRTUEMART_UNPUBLISH')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function archiveList($task = 'archive', $alt = 'JACTION_ARCHIVE')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function unarchiveList($task = 'unarchive', $alt = 'JACTION_UNARCHIVE')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function editHtml($task = 'edit_source', $alt = 'JACTION_EDIT_HTML')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function editCss($task = 'edit_css', $alt = 'JACTION_EDIT_CSS')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function deleteList($msg = '', $task = 'remove', $alt = 'COM_VIRTUEMART_DELETE')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function trash($task = 'remove', $alt = 'JACTION_TRASH', $check = true)
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function apply($task = 'apply', $alt = 'COM_VIRTUEMART_APPLY')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function save($task = 'save', $alt = 'JSAVE')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.6
	 */
	public static function save2new($task = 'save2new', $alt = 'JACTION_SAVE_AND_NEW')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.6
	 */
	public static function save2copy($task = 'save2copy', $alt = 'JACTION_SAVE_AS_COPY')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.7
	 */
	public static function checkin($task = 'checkin', $alt = 'JACTION_CHECKIN', $check = true)
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function cancel($task = 'cancel', $alt = 'JCANCEL')
	{
		$bar = JToolbar::getInstance('toolbar');
	 ...
	 * @since   1.5
	 */
	public static function preferences($component, $height = '550', $width = '875', $alt = 'JACTION_Options', $path = '')
	{
